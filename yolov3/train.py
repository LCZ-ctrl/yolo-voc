...
import config
from eval import predict_yolov3_batch, build_gts_from_targets, evaluate_map
...
def train():
    ...
    best_path = save_dir / "yolov3_voc_best.pth"
    ...
    ## save and show
    plt.tight_layout()
    plot_path = save_dir / 'yolov3_training_metrics.png'
