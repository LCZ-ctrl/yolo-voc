...
import config
from eval import predict_yolov2_batch, build_gts_from_targets, evaluate_map
...
def train():
    ...
    best_path = save_dir / "yolov2_voc_best.pth"
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.title('YOLOv2 Training Loss')
    plt.ylim(0, 16)
    ...
    ## save and show
    plt.tight_layout()
    plot_path = save_dir / 'yolov2_training_metrics.png'
