...
import config
from eval import predict_yolov5_batch, build_gts_from_targets, evaluate_map
...
def train():
    ...
    best_path = save_dir / "yolov5_voc_best.pth"
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.title('YOLOv5 Training Loss')
    plt.ylim(0, 15)
    ...
    ## save and show
    plt.tight_layout()
    plot_path = save_dir / 'yolov5_training_metrics.png'
