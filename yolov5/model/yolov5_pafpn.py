...
from .yolov5_backbone import Conv_BN_SiLU, CSPBlock
...
def build_fpn(model_name, in_channels, out_channels=None):
    width = cfg[model_name]['width']
    depth = cfg[model_name]['depth']

    if out_channels is None:
        out_channels = int(256 * width)

    fpn_net = Yolov5PaFPN(in_channels, out_channels, width, depth)
